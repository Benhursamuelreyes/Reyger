...
[![Versión](https://img.shields.io/badge/versión-v2.0.0--beta.5-blue.svg)](https://github.com/Benhursamuelreyes/Reyger/releases)
...
| Plataforma | Archivo |
|------------|---------|
| **Windows** | `Reyger-2.0.0b5.msi` |
| **macOS** | `Reyger-2.0.0b5.dmg` |
| **Linux** | `Reyger-2.0.0b5-x86_64.AppImage` |

### Guía de instalación por plataforma

**Windows**
1. Descarga el archivo `Reyger-2.0.0b5.msi`.
...
**macOS**
1. Descarga el archivo `Reyger-2.0.0b5.dmg`.
...
**Linux**
1. Descarga el archivo `Reyger-2.0.0b5-x86_64.AppImage`.
2. Hazlo ejecutable y lánzalo:
   ```bash
   chmod +x Reyger-2.0.0b5-x86_64.AppImage
   ./Reyger-2.0.0b5-x86_64.AppImage
   ```
