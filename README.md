...
[![Versión](https://img.shields.io/badge/versión-v3.0.0--beta.9-blue.svg)](https://github.com/Benhursamuelreyes/Reyger/releases)
...
| Plataforma | Archivo |
|------------|---------|
| **Windows** | `Reyger-3.0.0b9.msi` |
| **macOS** | `Reyger-3.0.0b9.dmg` |
| **Linux** | `Reyger-3.0.0b9-x86_64.AppImage` |

### Guía de instalación por plataforma

**Windows**
1. Descarga el archivo `Reyger-3.0.0b9.msi`.
...
**macOS**
1. Descarga el archivo `Reyger-3.0.0b9.dmg`.
...
**Linux**
1. Descarga el archivo `Reyger-3.0.0b9-x86_64.AppImage`.
2. Hazlo ejecutable y lánzalo:
   ```bash
   chmod +x Reyger-3.0.0b9-x86_64.AppImage
   ./Reyger-3.0.0b9-x86_64.AppImage
   ```
