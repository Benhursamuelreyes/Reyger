...
[![Versión](https://img.shields.io/badge/versión-v3.0.0--beta.10-blue.svg)](https://github.com/Benhursamuelreyes/Reyger/releases)
...
| Plataforma | Archivo |
|------------|---------|
| **Windows** | `Reyger-3.0.0b10.msi` |
| **macOS** | `Reyger-3.0.0b10.dmg` |
| **Linux** | `Reyger-3.0.0b10-x86_64.AppImage` |

### Guía de instalación por plataforma

**Windows**
1. Descarga el archivo `Reyger-3.0.0b10.msi`.
...
**macOS**
1. Descarga el archivo `Reyger-3.0.0b10.dmg`.
...
**Linux**
1. Descarga el archivo `Reyger-3.0.0b10-x86_64.AppImage`.
2. Hazlo ejecutable y lánzalo:
   ```bash
   chmod +x Reyger-3.0.0b10-x86_64.AppImage
   ./Reyger-3.0.0b10-x86_64.AppImage
   ```
