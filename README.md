...
[![Versión](https://img.shields.io/badge/versión-v1.0.0-blue.svg)](https://github.com/Benhursamuelreyes/Reyger/releases)
...
| Plataforma | Archivo |
|------------|---------|
| **Windows** | `Reyger-1.0.0.msi` |
| **macOS** | `Reyger-1.0.0.dmg` |
| **Linux** | `Reyger-1.0.0-x86_64.AppImage` |

### Guía de instalación por plataforma

**Windows**
1. Descarga el archivo `Reyger-1.0.0.msi`.
...
**macOS**
1. Descarga el archivo `Reyger-1.0.0.dmg`.
...
**Linux**
1. Descarga el archivo `Reyger-1.0.0-x86_64.AppImage`.
2. Hazlo ejecutable y lánzalo:
   ```bash
   chmod +x Reyger-1.0.0-x86_64.AppImage
   ./Reyger-1.0.0-x86_64.AppImage
   ```
