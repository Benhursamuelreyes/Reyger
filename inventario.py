...
class Inventario(tk.Frame):
    ...
    def widgets(self):
        ...
        self.tre = ttk.Treeview(treeFrame,yscrollcommand=scrol_y.set, xscrollcommand=scrol_x.set, height=40, columns=("ID", "PRODUCTO", "PROVEEDOR", "PRECIO", "COSTO", "STOCK"), show="headings")
        
        self.tre.pack(expand=True, fill=BOTH)
        
        scrol_y.config(command=self.tre.yview)
        scrol_y.config(command=self.tre.xview)
    ...
    def actualizar_inventario(self):
        ...
        messagebox.showinfo("Actualización", "El inbentario ha sido actualizado correctamente")
    ...
    def editar_producto(self):
        ...
        ventana_editar.config(bbg="C6D9E3")
        ...
        def guardar_cambio():
            ...
            consulta = "UPDATE inventario SET nombre=?, prveedor=?, precio, costo=?, stock=? WHERE id=?"
